...
고양이는 **전사·도적·궁수·마법사** 넷 중 하나이고, 각자 **자기만의 스킬**을 하나씩 갖는다.
같은 직업이라도 스킬은 서로 다르다.
...
| 도적 | 줄줄이 | 연속 찌르기 | 목표를 네 번 연달아 찌른다 |
| 궁수 | 호랑이 | 꿰뚫기 | 일직선 위의 적을 전부 관통한다 |
| 궁수 | 삼색이 | 삼색 화살 | 서로 다른 적 셋에게 동시에 쏜다 |
...
고양이 아래 파란 막대가 마나다. **공격할 때마다 차고, 가득 차면 스킬을 쓰고 0으로 돌아간다.**
