...
흰색이라(빙글밤·그림콩·서리별·실타래) 색상환을 아무리 돌려도 그대로다.
...
# 그중 가장 넓은 면적이 하필 순검정(빙글밤·그림콩)이거나 순백(악몽 넷)이다.
